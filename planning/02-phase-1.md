...
- [ ] Render `..` entry at top of file list (not yet implemented).
...
- ~~Research schemas from Phase 1.2 are available in `docs/research/` to inform Phase 2 implementation.~~ (Phase 1.2 not started — `docs/research/` does not exist)
